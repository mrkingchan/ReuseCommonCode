...
@interface EducationPicker () <UIPickerViewDelegate,UIPickerViewDataSource> {
...
+(instancetype)educationPickerWithComplete:(void (^)(NSString *selectedStr))complete {
    return [[EducationPicker alloc] initWithComplete:complete];
}

- (instancetype)initWithComplete:(void (^)(NSString *selectedStr))complete {
